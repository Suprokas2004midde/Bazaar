      ...
      for(const items in cartItems){
        for(const item in cartItems[items]){
          if(cartItems[items][item]>0){
            const iteminfo = structuredClone(productsData.find(product => product._id === items))
            if(iteminfo){
              iteminfo.size = item;
        ...
        <div className="mt-12">
          ...
          <div className="flex gap-3 flex-col lg:flex-row">
            ...
            >
              ...
              ></p>
              <span className="text-blue-600 font-semibold text-sm tracking-wide italic mx-4">
                stripe
              </span>
            </div>
