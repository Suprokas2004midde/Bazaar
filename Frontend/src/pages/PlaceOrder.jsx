...
const PlaceOrder = () => {
  ...
  return (
    <form
      ...
      className="flex flex-col lg:flex-row justify-between gap-8 pt-8 min-h-[80vh] border-t border-[var(--border-color)]/40"
    >
      {/* Delivery Info Form */}
          ...
          {!addingNewAddress && userAddresses.length > 0 ? (
            ...
            <div className="space-y-4 mt-2">
              ...
              <div className="flex items-center gap-2 mt-4 pt-2">
                ...
                <label
                  htmlFor="saveAddress"
                  className="text-sm cursor-pointer select-none text-[var(--text-main)] font-medium"
                >
        ...
        <Card className="border-[var(--border-color)]">
          <CardContent className="p-6 space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              ...
              >
                <span className="text-blue-500 font-bold text-xs italic">
                  stripe
                </span>
                {method === "stripe" && (
              ...
              >
                <span className="text-[#2c9ef4] font-extrabold text-xs">
                  Razorpay
                </span>
                {method === "razorpay" && (
                  <CheckCircle2 className="w-4 h-4 text-[var(--primary-accent)]" />
              ...
              >
                <span className="text-xs font-bold text-[#2c9ef4]">COD</span>
                {method === "cod" && (
                  <CheckCircle2 className="w-4 h-4 text-[var(--primary-accent)]" />
                )}
              </div>
