...
const Footer = () => {
  return (
    <footer className="mt-24 border-t border-[var(--border-color)]/40 pt-4 pb-5 text-sm">
      <div className="grid grid-cols-1 sm:grid-cols-[2fr_1fr_1fr] gap-15 pb-2">
        ...
        <div>
          ...
          <ul className="flex flex-col space-y-2 text-xs sm:text-sm text-[var(--text-muted)] font-medium">
            <li><Link to="/" className="hover:text-[#0980FF] transition-colors">Home</Link></li>
            <li><Link to="/about" className="hover:text-[#0980FF] transition-colors">About Us</Link></li>
            <li><Link to="/collection" className="hover:text-[#0980FF] transition-colors">Collection</Link></li>
            <li><span className="hover:text-[#0980FF] transition-colors cursor-pointer">Privacy Policy</span></li>
          </ul>
        </div>
      ...
      <div className="w-full border-t border-[var(--border-color)]/30 pt-6 items-center text-xs text-[var(--text-muted)] gap-2">
